...
<body>
	<%-- 파라미터 : client 서버로 요청을 보낼때 추가적으로 보낸 값
	 ...
	 --%>
	 <%-- 한글 파라미터 설정
	 	get : server.xml <Connection URIEncoding="utf-8">
	 ...
	 user id : <input type="text" name="userId" value="셀리"><br>
	 ...
	 <input type="radio" name="choice" value="GET" id="GET">GET<br>
	 <input type="radio" name="choice" value="POST" id="POST">POST<br>
</body>
</html>